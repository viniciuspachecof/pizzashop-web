...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 182313123</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">vinicius.pacheco@hotmail.com</TableCell>
            </TableRow>
            <TableRow>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-right">RS 139,80</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Pizza Mussarela Família</TableCell>
              <TableCell className="text-right">2</TableCell>
              <TableCell className="text-right">R$ 59,90</TableCell>
              <TableCell className="text-right">RS 119,80</TableCell>
            </TableRow>
          </TableBody>
          <TableFooter>
            <TableRow>
