...
export function OrderTableFilters() {
  ...
  return (
    <form onSubmit={handleSubmit(handleFilter)} className="flex items-center gap-2">
      ...
      <Button type="submit" variant="secondary" size="xs" className="cursor-pointer">
        <Search className="mr-2 h-4 w-4" />
        Filtrar resultados
      </Button>

      <Button onClick={handleClearFilters} type="button" variant="outline" size="xs" className="cursor-pointer">
